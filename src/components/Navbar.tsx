...
//   );
  ...
  return (
    <Navbar variant="gradient" color="deep-purple" placeholder="navbar" className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        <Typography
        placeholder=""
          as="a"
          href="#"
          className=" text-white mr-4 cursor-pointer py-1.5 font-medium"
